          ...
          content: {
            ...
            text: [
              ...
              args.customerId
                ...
                : "Chame list_accounts e escolha a conta desejada.",
              "Passos:",
              "1) get_campaign_performance com days=7",
              "2) get_performance_alerts com days=7",
              "3) get_purchase_conversions com days=7 (para separar compras de outras conversões)",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "Passos:",
              "1) compare_periods com os dois períodos",
              "2) Analise: spend subiu/caiu? ROAS melhorou? Conversões subiram?",
              "3) Se ROAS caiu, investigue: get_campaign_performance em cada período",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "Passos:",
              "1) run_gaql para buscar config da campanha (bidding, budget, status)",
              "2) get_daily_trend com campaignId para ver tendência diária (14 dias)",
              "3) get_keyword_performance com campaignId (se Search)",
              "4) get_search_terms com campaignId para ver termos reais",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "Passos:",
              "1) get_keyword_performance (30 dias) — identifique keywords com spend > R$50 e 0 conversões",
              "2) get_search_terms (30 dias) — identifique termos irrelevantes com spend",
              "3) list_negative_keywords — veja negativos já adicionados",
              "4) Sugira:",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "Passos:",
              "1) get_campaign_performance (30 dias) — todas as campanhas",
              "2) get_purchase_conversions (30 dias) — compras reais por campanha",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "Passos:",
              "1) get_account_settings — moeda, fuso, status, auto-tagging, acompanhamento de conversões, optimization score e alertas (e get_identity_verification para prazos de verificação do anunciante)",
              "2) get_campaign_performance (30 dias) — overview de campanhas",
              "3) get_purchase_conversions (30 dias) — separar compras reais",
              "4) get_performance_alerts (30 dias) — detectar problemas",
              "5) get_keyword_performance (30 dias) — top/worst keywords",
              "6) get_search_terms (30 dias) — termos irrelevantes",
              "7) get_device_breakdown (30 dias) — eficiência por device",
              "8) get_shopping_products (30 dias) — se tem Shopping/PMax",
